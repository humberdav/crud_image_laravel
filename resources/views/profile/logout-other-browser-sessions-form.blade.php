<x-jet-action-section>
    ...
    <x-slot name="description">
        {{ __('Administra tus sesiones activas y finalizalas en otros dispositivos.') }}
    </x-slot>
    ...
    <x-slot name="content">
        ...
        <div class="flex items-center mt-5">
            <x-jet-button wire:click="confirmLogout" wire:loading.attr="disabled">
                {{ __('Cierra la sesión en los otros navegadores') }}
            </x-jet-button>
        ...
        <x-jet-dialog-modal wire:model="confirmingLogout">
            ...
            <x-slot name="content">
                {{ __('Por favor, escribe tu contraseña para confirmar el cierre de las otras sesiones.') }}
